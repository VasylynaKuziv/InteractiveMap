...
function init() {
  ...
  projection = d3.geoMercator()
    .center([32, 48.5])                // GPS of location to zoom on
  ...
  color = d3.scaleOrdinal()
    .domain(types)
    .range(['#dbd7d7', '#b2b0b0', , '#f01313', '#989898', '#eae8e8', "#6a0300", '#fd6a67', '#242224'])
...
function drawEvents() {
  ...
  g
    ...
    .attr("r", function (d) {
      console.log(size(d.num_events))
      return size(d.num_events)
    })
